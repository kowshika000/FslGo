    ...
    <div className='address_content'>
        <div className="header_manage_account" style={{position:"relative"}}>
            ...
            <div className="plus_icon">
             <Link className='text-decoration-none'><span style={{color:"#181E25"}}><FaPlus className='me-1' size={14} />Add More</span></Link>
            </div>
        </div>
        <div className="header_branch_address mt-3" style={{position:"relative"}}>
          <div className='d-flex justify-content-between align-items-center' style={{ marginBottom: "11px"}}>
            ...
            <span className='m-0 dot_icon'><Link className='text-decoration-none' style={{color:"#384656"}}><PiDotsThreeVerticalBold size={16} /></Link></span>
          </div>
