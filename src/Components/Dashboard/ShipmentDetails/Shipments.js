...
const Shipments = () => {
  ...
  const ShipmentData1 = ShipmentData ? ShipmentData.shipmentCount.statuswise_count:"null";
          ...
          <div className="col ">
            <Box sx={{ display: "flex", justifyContent: "space-between" }}>
              <Box sx={{ display: "flex", padding: "8px" }} role = "button" onClick={handleShipmentsClick}>
                ...
                <span style={{color:"#B3B2BA"}}>({ShipmentData1?.overall_count})</span></Typography>
              </Box>
        ...
        >
          <div className="w-100 d-flex">
            ...
            >
              ...
              {(ShipmentData1?.new_request)?(ShipmentData1?.new_request):"0"}
              </Typography>
              <Typography
          ...
          <div className="w-100 d-flex mb-4">
            ...
            >
              <Typography className="bold text-start px-3" sx={{ fontSize: "20px" }}>
              {(ShipmentData1?.delivered)?(ShipmentData1?.arrived):"0"}
              </Typography>
              <Typography
