...
const Origin = ({originPortOptionsVisible,setOriginPortOptionsVisible,setDestPortOptionsVisible}) => {
  ...
  const filteredSeaPorts = originPortDataValue?.filter((item)=>item.Transport_mode==="SEA")
  const filteredAirPorts = originPortDataValue?.filter((item)=>item.Transport_mode==="AIR")
  const filteredCityPorts = originPortDataValue?.filter((item)=>item.Transport_mode==="CITY")
    ...
    <>
      ...
      <Location style={{ width:"20px", height:'20px'}} className="mx-2"/>
        ...
        <div className="w-100">
          ...
          <input
            type="text"
            style={{ border: "none", outline: "none", width: "90%", background: 'transparent',fontWeight:"600", fontSize:"16px",lineHeight:"22px", letterSpacing:".01em" }}
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div>
                    ...
                    >
                      Sea Port <span 
                      style={{color: "rgba(103, 120, 142, 1)",
                              fontSize: "13px",
                              fontWeight: 400,
                              lineHeight:"19px",
                              letterSpacing:".01em"}}>
